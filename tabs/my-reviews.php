...
$text = "";
$link = "https://cdn.trustindex.io/assets/platform/".ucfirst("thumbtack")."/star/";
if (!is_numeric($score)) {
return $text;
}
...
<?php echo $pluginManagerInstance->getProFeatureButton('wp-thumbtack-pro'); ?>
</div>
...
<td class="ti-text-center source-<?php echo ucfirst("thumbtack") ?>"><?php echo trustindex_plugin_write_rating_stars($review->rating); ?></td>
...
<?php endif; ?>
<a href="<?php echo esc_attr($review->id); ?>" data-nonce="<?php echo wp_create_nonce('ti-save-reply'); ?>" class="ti-btn ti-btn-sm btn-post-reply"><?php echo sprintf(__('Upload reply to %s', 'trustindex-plugin'), 'Thumbtack'); ?></a>
...
<?php endif; ?>
<?php
$tiCampaign1 = 'wp-thumbtack-4';
$tiCampaign2 = 'wp-thumbtack-5';
