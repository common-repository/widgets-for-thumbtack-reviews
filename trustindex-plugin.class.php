<?php
class TrustindexPlugin_thumbtack
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Thumbtack Reviews", "do-not-care-Thumbtack");
